...
for simulation, R30, MV in zip(simulations, R30s, MVs):
	...
	metalPop2 = np.array(dataPop2.getDataArray(enums.T_star, getProp('[Fe/H]'), False))
	if not metalPop2.size:
