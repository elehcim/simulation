...
setup(name='simulation',
      ...
      install_requires=['pynbody', 'astropy', 'pandas', 'matplotlib', 'scipy', 'numpy', 'scikit-image', 'numpy-quaternion', 'numba'],
      packages=['simulation', 'simulation.plot', 'simulation.parsers', 'simulation.interp'],
      package_data={'simulation': ['interp/tables/HI_data_all.npz']},
